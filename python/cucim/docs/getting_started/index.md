...
Please download the latest SDK package (`cuCIM-v22.02.01-linux.tar.gz`).

Untar the downloaded file.

```bash
mkdir -p cuCIM-v22.02.01
tar -xzvf cuCIM-v22.02.01-linux.tar.gz -C cuCIM-v22.02.01
...
[Plugin: cucim.kit.cuslide] Loading the dynamic library from: cucim.kit.cuslide@22.02.01.so
