...
Please download the latest SDK package (`cuCIM-v21.12.01-linux.tar.gz`).

Untar the downloaded file.

```bash
mkdir -p cuCIM-v21.12.01
tar -xzvf cuCIM-v21.12.01-linux.tar.gz -C cuCIM-v21.12.01
...
[Plugin: cucim.kit.cuslide] Loading the dynamic library from: cucim.kit.cuslide@21.12.01.so
